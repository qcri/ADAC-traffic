...
class gharaffaEnv(gym.Env):
    ...
    def _configure_environment(self):
        ...
        self.argslist = [sumoBin, "-n", module_path + "/assets/ec.net.xml",
                         "-r", module_path + "/assets/MATOD/ec_" + str(self.s_hour) + ".passenger.trips.xml",
                         "-a", module_path + "/assets/TAZ/ec_taz.xml, " + module_path + "/assets/e1test.xml",
